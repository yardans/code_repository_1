package org.happybuy.controller.admin;
...
import org.happybuy.pojo.GoodsExample;
import org.happybuy.pojo.ImagePath;
import org.happybuy.pojo.Msg;
import org.happybuy.pojo.User;
import org.happybuy.pojo.GoodsExample.Criteria;
...
public class newsController {
	...
	public Msg getAllGoods(@RequestParam(value = "page", defaultValue = "1") Integer pn, HttpServletResponse response,
		...
		criteria.andCategoryIn(Arrays.asList(new Integer[]{1,2,3}));
	...
	public String goodsManage(@RequestParam(value = "page", defaultValue = "1") Integer pn,
		...
		org.happybuy.pojo.CategoryExample.Criteria criteria = categoryExample.createCriteria();
		criteria.andCateidIn(Arrays.asList(new Integer[]{1,2,3}));
