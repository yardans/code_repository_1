...
function build_goods_table(path,result) {
    ...
    $.each(goods, function (index,item) {
        ...
        $("<tr></tr>").append(goodsid).append(goodsname).append(price).append(num).append(detailcate).append(desTd).append(detailTd).append(editTd).append(deleteTd).appendTo("#goodsinfo tbody");
    })
}
