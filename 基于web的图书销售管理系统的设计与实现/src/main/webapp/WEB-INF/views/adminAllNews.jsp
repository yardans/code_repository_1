        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="update-form" name="update-form" method="post">
                    ...
                    <div class="form-group">
                        <label for="goodsname" class="col-sm-2 control-label">资讯名</label>
                        <div class="col-sm-9">
    ...
    <div class="row">
        <nav class="templatemo-top-nav col-lg-12 col-md-12">
            <ul class="text-uppercase">
                <li><a href="${pageContext.request.contextPath}/admin/news/show">所有公告</a></li>
                <li><a href="${pageContext.request.contextPath}/admin/news/add">添加公告</a></li>
                ...
                <div class="panel panel-default table-responsive">
                    <table id="goodsinfo" class="table table-striped table-bordered templatemo-user-table">
                        ...
                        <tr>
                            ...
                            <td><a href="" class="white-text templatemo-sort-by">公告名<span class="caret"></span></a></td>
...
<script src="${pageContext.request.contextPath}/js/newsManage.js"></script>
<!-- Templatemo Script -->
<script>
