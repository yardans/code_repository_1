...
<body>
		...
		<div class="row content">
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="breadcrumbs">
					<p>
						<a href="#">主页</a> <i class="icons icon-right-dir"></i> ${cate }
					</p>
				</div>
			</div>
			...
			<!-- Main Content -->
			<section
				class="main-content col-lg-9 col-md-9 col-sm-9 col-lg-push-3 col-md-push-3 col-sm-push-3">
	...
	<div class="row">
					...
					<nav>
						<ul class="pagination">
							<c:if test="${pageInfo.hasPreviousPage}">
								<li><a
									href="${pageContext.request.contextPath}/category?cate=${cate}&page=${pageInfo.prePage}"
							...
							<c:forEach items="${pageInfo.navigatepageNums}" var="pageNums">
								<c:if test="${pageNums == pageInfo.pageNum}">
									<li class="active"><a
										href="${pageContext.request.contextPath}/category?cate=${cate}&page=${pageNums}">${pageNums}</a></li>
								</c:if>
								<c:if test="${pageNums != pageInfo.pageNum}">
									<li><a
										href="${pageContext.request.contextPath}/category?cate=${cate}&page=${pageNums}">${pageNums}</a></li>
							...
							<c:if test="${pageInfo.hasNextPage}">
								<li><a
									href="${pageContext.request.contextPath}/category?cate=${cate}&page=${pageInfo.nextPage}"
			...
			<!-- Sidebar -->
			<aside
				class="sidebar col-lg-3 col-md-3 col-sm-3  col-lg-pull-9 col-md-pull-9 col-sm-pull-9">
				...
				<div class="row sidebar-box purple">
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="sidebar-box-content">
							<ul>
								<li><a
									href="${pageContext.request.contextPath}/category?cate=">全部
										<i class="icons icon-right-dir"></i>
								</a></li>
								<c:forEach items="${categoryList}" var="category">
									<li><a
										href="${pageContext.request.contextPath}/category?cate=${category.catename}">${category.catename}
											<i class="icons icon-right-dir"></i>
									</a></li>
								</c:forEach>
