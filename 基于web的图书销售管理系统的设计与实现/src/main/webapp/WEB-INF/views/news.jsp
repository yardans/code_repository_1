	...
	<div id="main" class="container">
		...
		<div class="content">
			...
			<div class="btn-group" role="group" aria-label="...">
				<a href="${pageContext.request.contextPath}/news?cate="
					class="btn btn-default" role="button">全部</a>
				<c:forEach items="${categoryList}" var="category">
					<a
						href="${pageContext.request.contextPath}/news?cate=${category.catename}"
						class="btn btn-default" role="button">${category.catename}</a>
				</c:forEach>
						...
						<ul>
							<c:forEach items="${pageInfo.list}" var="goods">
								<li class="data-item-li">
									<div class="to-big"
										style="width:260px;height: 260px;display: table-cell;vertical-align: middle;">
										<a
											href="${pageContext.request.contextPath}/newsdetail?goodsid=${goods.goodsid}">
									...
									<p class="text-right">
										<a
											href="${pageContext.request.contextPath}/newsdetail?goodsid=${goods.goodsid}">${goods.goodsname}</a>
									</p>
