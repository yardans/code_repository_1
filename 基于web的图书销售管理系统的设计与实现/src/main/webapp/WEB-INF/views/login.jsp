				...
				<div class="col-md-5 form-login">
					<div>
						...
						<form class="form-horizontal" id="form2"
							action="${pageContext.request.contextPath}/loginconfirm"
							method="post">
							...
							<div class="form-group">
								...
								<img
									src="${pageContext.request.contextPath}/verificationcodeimg"
									id="code" onclick="reloadcode()" style="cursor: pointer;margin-left:100px;"
