...
<title>产品-${goodsInfo['goods'].goodsname}</title>
				...
				<div class="row content">
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="breadcrumbs">
							<p>
								<a href="#">主页</a> <i class="icons icon-right-dir"></i>
							...
							<div id="leftbox">
								<div id="showbox">
									<c:forEach items="${goodsInfo['image']}" var="path">
										<img
											src="${pageContext.request.contextPath}/shopimage/${path.path}"
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						...
						<div class="elav_info">
							...
							<div class="product-inner-price">
								...
								<span style="font-size: 30px;color: red;">￥${goodsInfo['goods'].price}</span>

							</div>
							<div class="product-inner-category">
								<p>
									类别: <a>${goodsInfo['cate'].catename}</a>
								</p>
							</div>
							<div class="product-inner-category">
								<p>
									数量: <a>${goodsInfo['goods'].num}</a>
								</p>
							</div>
							...
							<div class="rel-div">
								<%-- <div class="add_defi new_meta">
									<a id="chatto"
										href="${pageContext.request.contextPath}/chat?sendto=5"
										data-original-title="Add to Wishlist" data-toggle="tooltip"
										class=" big-font"> <i class="fa fa-commenting"></i> 联系客服
									</a>
								</div> --%>
								<form class="cart-btn-area new_meta"
									...
									<input type="hidden" value="${goodsInfo['goods'].goodsid}"
										name="goodsid" /> <input type="number" value="1"
										name="goodsnum">
								...
								<div class="add_defi new_meta">
									<a href="javacript:void(0);"
										data-original-title="Add to Wishlist" data-toggle="tooltip"
										class="fav-button big-font"
										data-id="${goodsInfo['goods'].goodsid}"> <c:if
											test="${goodsInfo['goods'].fav}">
											<i class="fa fa-heart"></i>
											<span class="like-content">取消收藏</span>
						...
						<div class="my-tabs">
							...
							<ul class="product-tab" role="tablist">
								...
								<li role="presentation" class="active"><a href="#home"
									aria-controls="home" role="tab" data-toggle="tab">商品描述</a></li>
								<li role="presentation"><a href="#profile"
									aria-controls="profile" role="tab" data-toggle="tab">评价
								...
								<div role="tabpanel" class="tab-pane active" id="home">
									<div class="row">
										<div class="col-md-12 col-xs-12">
											<div class="tb_desc">
												<h2>商品描述</h2>
												<p class="br">${goodsInfo['goods'].description}</p>
											</div>
										</div>
									</div>
								</div>
																		...
																		<div class="comment-text">
																			...
																			<p class="meta">
																				...
																				<time datetime="${comment.commenttime}">
																					...
																					${comment.commenttime.date}日 </time>
																				:
